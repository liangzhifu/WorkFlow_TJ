...
var agreementDetail = (function() {
	...
	return {		
		initBasicPanel : function(){
			var items = new Array();
			var historyAgreementJSON2 = historyAgreementJSON.replace("\\", '\\\\');
			historyAgreementJSON2 = historyAgreementJSON2.replace(/\r\n/g,'</br>');
			historyAgreementJSON2 = historyAgreementJSON2.replace(/\n\r/g,'</br>');
			historyAgreementJSON2 = historyAgreementJSON2.replace(/\n/g,'</br>');
			var historyAgreement = Ext.decode(historyAgreementJSON2);
			items = [{ 
		            columnWidth:.25,
		            layout:'form',
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'发行编号',
			            value:'<a href="'+contextPath+'/taskDetail/getTaskDetailDlg.do?orderId='+historyAgreement.orderId+'" target="_blank">'+historyAgreement.publishCode+'</a>',
			            anchor:'100%'
		            }]
            	},{ 
		            columnWidth:.25,
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'立合编号',
			            value:historyAgreement.agreementName,
			            anchor:'100%'
		            }]
            	},{ 
		            columnWidth:.25,
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'创建人',
			            value:historyAgreement.createUser,
			            anchor:'100%'
		            }]
            	},{ 
		            columnWidth:.25,
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'创建时间',
			            value:historyAgreement.createTimeStr,
			            anchor:'100%'
		            }]
            	},{ 
		            columnWidth:.25,
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'工程',
			            value:historyAgreement.project,
			            anchor:'100%'
		            }]
            	},{ 
		            columnWidth:.25,
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'数量',
			            value:historyAgreement.num,
			            anchor:'100%'
		            }]
            	}];
			var agreementTacheArray = historyAgreement.agreementTacheList;
			...
			items[agreementTacheArray.length + 7] = {
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'结论',
			            value:historyAgreement.conclusionState,
			            anchor:'100%'
		            }]
			};
			items[agreementTacheArray.length + 8] = {
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'详细说明',
			            value:historyAgreement.conclusionMessage,
			            anchor:'100%'
		            }]
			};
			items[agreementTacheArray.length + 9] = {
		            ...
		            items:[{ 
		            	xtype:'displayfield',
			            fieldLabel:'追踪者',
			            value:historyAgreement.trackName,
			            anchor:'100%'
		            }]
			};
	    ...
	    initMainPanel : function(){
			...
			historyAgreementJSON2 = historyAgreementJSON2.replace(/\n/g,'</br>');
			var historyAgreement = Ext.decode(historyAgreementJSON2);
	    	var historyAgreementConfirmArray = historyAgreement.historyAgreementContentList;
	    	for(var i = 0; i < historyAgreementConfirmArray.length; i++){
				var data = generMainObj(historyAgreement.orderId, historyAgreementConfirmArray[i]);
				dataArray[i] = data;
			}
