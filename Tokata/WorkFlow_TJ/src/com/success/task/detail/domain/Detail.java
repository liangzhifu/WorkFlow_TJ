...
public class Detail {
	...
	public void setRequireCompleteTime(String requireCompleteTime) {
	...
	public Integer getCycleIsDelay() {
		return cycleIsDelay;
	}

	public void setCycleIsDelay(Integer cycleIsDelay) {
		this.cycleIsDelay = cycleIsDelay;
	}
