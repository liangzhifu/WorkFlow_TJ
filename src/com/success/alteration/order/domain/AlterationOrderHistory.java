...
public class AlterationOrderHistory {
    ...
    private FourOrder fourOrder;

    private List<FourOrderAttr> fourOrderAttrList;
    ...
    public FourOrder getFourOrder() {
        return fourOrder;
    }

    public void setFourOrder(FourOrder fourOrder) {
        this.fourOrder = fourOrder;
    }

    public List<FourOrderAttr> getFourOrderAttrList() {
        return fourOrderAttrList;
    }

    public void setFourOrderAttrList(List<FourOrderAttr> fourOrderAttrList) {
        this.fourOrderAttrList = fourOrderAttrList;
    }
