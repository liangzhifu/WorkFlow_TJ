...
<html>
	...
	<script type="text/javascript" src="/IOMPROJ/ext/kpi/js/kpiMain.js"></script>
	<script type="text/javascript" src="/IOMPROJ/ext/kpi/js/default.js"></script>
	<script language="javascript" src="/IOMPROJ/public/script/AlternateData.js"></script>
