var woAttrUploadApp = angular.module("woAttrUpload", []);
woAttrUploadApp.config(['$locationProvider', function($locationProvider) {
    $locationProvider.html5Mode(true);
}]);
woAttrUploadApp.controller("woAttrUploadController", ["$scope", "$location", function ($scope, $location) {
...
angular.bootstrap(document, [ 'woAttrUpload' ]);