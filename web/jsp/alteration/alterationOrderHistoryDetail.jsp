...
<body ng-controller="alterationOrderHistoryDetailController" ng-cloak>
<form class="form-inline" id="alterationOrderHistoryDetailForm">
                        ...
                        <div class="block" style="margin-top: 0px; margin-bottom: 0px;padding: 5px 0px;">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.kirikaeOrderType" name="kirikaeOrder.kirikaeOrderType" disabled
                                            ...
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.kirikaeOrderType==1">量产前</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.kirikaeOrderType==2">量产后</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.kirikaeOrderState" name="kirikaeOrder.kirikaeOrderState" disabled
                                                class="form-control-order form-control clean" required="required" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.kirikaeOrderState==1">已切替</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.kirikaeOrderState==2">切替注意</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.kirikaeOrderState==3">切替日已过</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.kirikaeOrderState==4">随切/特定切</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.kirikaeOrderState==5">废除</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.tkNo" name="kirikaeOrder.tkNo" required="required" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.tkNo" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.designChangeNo" name="kirikaeOrder.designChangeNo" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.designChangeNo" class="form-control-order form-control clean">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.salesDate" name="kirikaeOrder.salesDate" data-type="date" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.salesDate" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.salesApproved" name="kirikaeOrder.salesApproved" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.salesApproved" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.salesChecked" name="kirikaeOrder.salesChecked" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.salesChecked" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.salesPrepared" name="kirikaeOrder.salesPrepared" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.salesPrepared" class="form-control-order form-control clean">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.engineeringData" name="kirikaeOrder.engineeringData" data-type="date" style="font-size: 12px;height: 25px;"
                                               ng-model="alterationOrderHistory.kirikaeOrder.engineeringData" class="form-control-order form-control clean" disabled>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.engineeringApproved" name="kirikaeOrder.engineeringApproved" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.engineeringApproved" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.engineeringChecked" name="kirikaeOrder.engineeringChecked" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.engineeringChecked" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.engineeringPrepared" name="kirikaeOrder.engineeringPrepared" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.engineeringPrepared" class="form-control-order form-control clean" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.salesCustomerProtocal" name="kirikaeOrder.salesCustomerProtocal" disabled
                                            ...
                                            <option value="">请选择</option>
                                            <option value="0" ng-selected="alterationOrderHistory.kirikaeOrder.salesCustomerProtocal==0">否</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.salesCustomerProtocal==1">是</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.distributionDepartment" name="kirikaeOrder.distributionDepartment" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.distributionDepartment" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.customer" name="kirikaeOrder.customer" style="font-size: 12px;height: 25px;" required="required" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.customer" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.vehicleName" name="kirikaeOrder.vehicleName" style="font-size: 12px;height: 25px;" required="required"
                                               ng-model="alterationOrderHistory.kirikaeOrder.vehicleName" class="form-control-order form-control clean" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.destination" name="kirikaeOrder.destination" style="font-size: 12px;height: 25px;" disabled
                                               ng-model="alterationOrderHistory.kirikaeOrder.destination" class="form-control-order form-control clean">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.isirProcessing" name="kirikaeOrder.isirProcessing" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.isirProcessing==1">要</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.isirProcessing==2">不要</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.customerEngineering" name="kirikaeOrder.customerEngineering" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.customerEngineering==1">要</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.customerEngineering==2">不要</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.customerEngineeringApproval" name="kirikaeOrder.customerEngineeringApproval"
                                            ...
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.customerEngineeringApproval==1">承认</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.customerEngineeringApproval==2">未承认</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.regulation" name="kirikaeOrder.regulation" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.regulation==1">有</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.regulation==2">无</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.regulationApproval" name="kirikaeOrder.regulationApproval" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.regulationApproval==1">认可</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.regulationApproval==2">不认可</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.interchangeabilityOld" name="kirikaeOrder.interchangeabilityOld" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="A" ng-selected="alterationOrderHistory.kirikaeOrder.interchangeabilityOld=='A'">A</option>
                                            <option value="B" ng-selected="alterationOrderHistory.kirikaeOrder.interchangeabilityOld=='B'">B</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.interchangeabilityNew" name="kirikaeOrder.interchangeabilityNew"
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;" disabled>
                                            <option value="">请选择</option>
                                            <option value="C" ng-selected="alterationOrderHistory.kirikaeOrder.interchangeabilityNew=='C'">C</option>
                                            <option value="D" ng-selected="alterationOrderHistory.kirikaeOrder.interchangeabilityNew=='D'">D</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.serviceSuplied" name="kirikaeOrder.serviceSuplied" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.serviceSuplied==1">有</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.serviceSuplied==2">无</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.designCosts" name="kirikaeOrder.designCosts" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.designCosts==1">有</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.designCosts==2">无</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.designCostsPay" name="kirikaeOrder.designCostsPay" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.designCostsPay==1">客户</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.designCostsPay==2">高田</option>
                                            <option value="3" ng-selected="alterationOrderHistory.kirikaeOrder.designCostsPay==3">供应商</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.customerEo" name="kirikaeOrder.customerEo" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.customerEo==1">有</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.customerEo==2">无</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.partsNumberChange" name="kirikaeOrder.partsNumberChange" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.partsNumberChange==1">有</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.partsNumberChange==2">无</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.presenceRequired" name="kirikaeOrder.presenceRequired"
                                            ...
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.presenceRequired==1">需要</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.presenceRequired==2">不需要</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.designChangeTiming" name="kirikaeOrder.designChangeTiming" data-type="date" style="font-size: 12px;height: 25px;"
                                               ng-model="alterationOrderHistory.kirikaeOrder.designChangeTiming" class="form-control-order form-control clean" disabled>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select title="" id="kirikaeOrder.desingChangeType" name="kirikaeOrder.desingChangeType" disabled
                                                class="form-control-order form-control clean" style="font-size: 12px;height: 25px;padding: 0px;">
                                            <option value="">请选择</option>
                                            <option value="1" ng-selected="alterationOrderHistory.kirikaeOrder.desingChangeType==1">高田</option>
                                            <option value="2" ng-selected="alterationOrderHistory.kirikaeOrder.desingChangeType==2">客户</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input title="" id="kirikaeOrder.manufactureInternal" name="kirikaeOrder.manufactureInternal" style="font-size: 12px;height: 25px;" disabled
                                           ng-model="alterationOrderHistory.kirikaeOrder.manufactureInternal" class="form-control-order form-control clean">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input title="" id="kirikaeOrder.manufacturePrepared" name="kirikaeOrder.manufacturePrepared" style="font-size: 12px;height: 25px;" disabled
                                           ng-model="alterationOrderHistory.kirikaeOrder.manufacturePrepared" class="form-control-order form-control clean">
                                </div>
                            </div>
                            <div class="block-header">
                                <div>
                            ...
                            <div style="padding-bottom: 10px;">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <tr ng-repeat="data in alterationOrderHistory.kirikaeOrderChangeContentList">
                                        <td>
                                            <input title="" id="kirikaeOrderChangeContentList[{{$index}}].beforeChange"
                                                   ...
                                                   ng-model="alterationOrderHistory.kirikaeOrderChangeContentList[$index].beforeChange"
                                        ...
                                        <td>
                                            <input type="hidden" id="kirikaeOrderChangeContentList[{{$index}}].beforeFileId"
                                                   ...
                                                   ng-model="alterationOrderHistory.kirikaeOrderChangeContentList[$index].beforeFileId"
                                        ...
                                        <td>
                                            <input title="" id="kirikaeOrderChangeContentList[{{$index}}].afterChange"
                                                   ...
                                                   ng-model="alterationOrderHistory.kirikaeOrderChangeContentList[$index].afterChange"
                                                   class="form-control-order form-control clean" style="width: 95%;font-size: 12px;height: 25px;" />
                                        </td>
                                        <td>
                                            <input type="hidden" id="kirikaeOrderChangeContentList[{{$index}}].newFileId"
                                                   ...
                                                   ng-model="alterationOrderHistory.kirikaeOrderChangeContentList[$index].newFileId"
                                                   class="form-control-order form-control clean" />
                            ...
                            <div style="padding-bottom: 10px;">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <tr ng-repeat="data in alterationOrderHistory.kirikaeOrderPartsNumberList">
                                        <td>
                                            <input title="" id="kirikaeOrderPartsNumberList[{{$index}}].oldPartsNumber" disabled
                                                   ...
                                                   ng-model="alterationOrderHistory.kirikaeOrderPartsNumberList[$index].oldPartsNumber"
                                        ...
                                        <td>
                                            <input title="" id="kirikaeOrderPartsNumberList[{{$index}}].newPattsNumber" disabled
                                                   ...
                                                   ng-model="alterationOrderHistory.kirikaeOrderPartsNumberList[$index].newPattsNumber"
                                                   class="form-control-order form-control clean required-class" style="font-size: 12px;height: 25px;width: 95%" />
                                        </td>
                                    </tr>
                                    </tbody>
...
<script src="<%=request.getContextPath()%>/js/module/alteration/alterationOrderHistoryDetail.js"></script>
</html>