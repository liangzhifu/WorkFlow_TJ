...
<body ng-controller="kirikaeConfirmationController" ng-cloak>
<form class="form-inline" id="kirikaeConfirmationForm" >
            ...
            <div class="page-content">
                ...
                <div class="modal-body" style="padding: 0px;">
                    <div class="modal-footer">
                        <button type="button" ng-click="addKirikaeConfirmation()"
...
<script src="<%=request.getContextPath()%>/js/module/kirikae/confirmation/kirikaeConfirmation.js"></script>
</html>
