...
<body ng-controller="kirikaeConfirmationApprovedController" ng-cloak>
<form class="form-inline" id="kirikaeConfirmationApprovedForm" >
            ...
            <div class="page-content">
                ...
                <div class="modal-body" style="padding: 0px;">
                    <div class="modal-footer">
                        <button type="button" ng-click="approvedKirikaeConfirmation()"
...
<script src="<%=request.getContextPath()%>/js/module/kirikae/confirmation/kirikaeConfirmationApproved.js"></script>
</html>
