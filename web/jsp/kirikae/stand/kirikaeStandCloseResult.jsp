...
<body ng-controller="woAttrStandCloseReusltController" ng-cloak>
<form class="form-inline" id="woAttrStandCloseReusltForm">
                        ...
                        <div class="block" style="margin-top: 0px; margin-bottom: 0px;padding: 5px 0px;">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr ng-repeat="data in woAttrList">
                                        ...
                                        <td>
                                            ...
                                            <select title="" id="kirikaeWoOrderAttrList[{{$index}}].agreementResult" name="kirikaeWoOrderAttrList[{{$index}}].agreementResult"
                            ...
                            <div class="modal-body" style="padding: 0px;">
                                <div class="modal-footer">
                                    <button type="button" ng-click="submitWoAttrStandCloseResult()"
                                            class="btn btn-small btn-primary">确定</button>
                                    <button type="button" ng-click="closeWoAttrStandCloseResult()"
...
<script src="<%=request.getContextPath()%>/js/module/kirikae/stand/kirikaeStandCloseResult.js"></script>
</html>