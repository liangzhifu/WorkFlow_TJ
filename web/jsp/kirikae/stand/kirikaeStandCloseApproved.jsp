...
<body ng-controller="standCloseApprovedController" ng-cloak>
<form class="form-inline" id="standCloseApprovedForm">
                        ...
                        <div class="block" style="margin-top: 0px; margin-bottom: 0px;padding: 5px 0px;">
                            ...
                            <div class="modal-body" style="padding: 0px;">
                                <div class="modal-footer">
                                    <button type="button" ng-click="submitStandCloseApproved()"
                                            class="btn btn-small btn-primary">承认</button>
                                    <button type="button" ng-click="closeStandCloseApproved()"
...
<script src="<%=request.getContextPath()%>/js/module/kirikae/stand/kirikaeStandCloseApproved.js"></script>
</html>