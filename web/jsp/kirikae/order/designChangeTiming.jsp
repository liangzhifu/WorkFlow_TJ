...
<html>
<head>
    <title>确认切替日期页面</title>
    <%@include file="../../public/css.jsp"%>
    <%@include file="../../public/js.jsp"%>
</head>
<body ng-controller="designChangeTimingController" ng-cloak>
<form class="form-inline" id="designChangeTimingForm">
                        ...
                        <div class="block" style="margin-top: 0px; margin-bottom: 0px;padding: 5px 0px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input title="" id="kirikaeOrder.designChangeTiming" name="kirikaeOrder.designChangeTiming" data-type="date" style="font-size: 12px;height: 25px;"
                                               ng-model="alterationOrder.kirikaeOrder.designChangeTiming" class="form-control-order form-control clean" required="required">
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="modal-body" style="padding: 0px;">
                                <div class="modal-footer">
                                    <button type="button" ng-click="confirmDesignChangeTiming()"
                                            class="btn btn-small btn-primary">确定</button>
                                    <button type="button" ng-click="closeDesignChangeTiming()"
...
<script src="<%=request.getContextPath()%>/js/module/kirikae/order/designChangeTiming.js"></script>
</html>