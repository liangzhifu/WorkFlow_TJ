...
<body ng-controller="woAttrUploadController" ng-cloak>
<form class="form-inline" id="woAttrUploadForm">
...
<script src="<%=request.getContextPath()%>/js/module/kirikae/wo/woAttrUpload.js"></script>
</html>