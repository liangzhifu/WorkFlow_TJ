...
<body ng-controller="kirikaeInstructionCheckedController" ng-cloak>
<form class="form-inline" id="kirikaeInstructionCheckedForm" >
            ...
            <div class="page-content">
                ...
                <div class="modal-body" style="padding: 0px;">
                    <div class="modal-footer">
                        <button type="button" ng-click="kirikaeInstructionChecked()"
...
<script src="<%=request.getContextPath()%>/js/module/kirikae/instruction/kirikaeInstructionChecked.js"></script>
</html>
